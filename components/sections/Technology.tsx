...
const techData = [
  {
    id: "01",
    title: "D3O® Kinetic Matrix",
    category: "Impact Defense",
    metrics: [
      { label: "Force Dispersion", value: "94%" },
      { label: "Weight Reduction", value: "32%" },
    ],
    desc: "Non-Newtonian polymers remain completely fluid under normal conditions but instantly lock upon high-velocity impact, absorbing and dispersing catastrophic kinetic energy before it reaches the body.",
    img: "/assets/peterlesliemorris-motorcycle-1829461_1920.webp",
  },
  {
    id: "02",
    title: "Aero-Exhaust Venting",
    category: "Thermoregulation",
    metrics: [
      { label: "Core Temp Cut", value: "-12°C" },
      { label: "Airflow Volume", value: "45 CFM" },
    ],
    desc: "Laser-perforated titanium micro-vents paired with exhausted aerodynamics. Creates an active vacuum system that pulls heat violently away from the rider's core at high speeds.",
    img: "/assets/splitshire-biker-407123_1920.webp",
  },
  {
    id: "03",
    title: "Aramid Sub-Structure",
    category: "Structural Integrity",
    metrics: [
      { label: "Tensile Strength", value: "3.6 GPa" },
      { label: "Abrasion Rating", value: "CE-AAA" },
    ],
    desc: "An indestructible sub-dermal mesh of Kevlar® and aramid fibers bonded directly to the primary chassis. Ensures absolutely zero blowout during hyper-speed surface friction.",
    img: "/assets/stocksnap-dark-2598357_1920.webp",
  },
  {
    id: "04",
    title: "Nano-Ceramic Bonding",
    category: "Surface Technology",
    metrics: [
      { label: "Hydrophobic", value: "10K/10K" },
      { label: "Drag Coeff", value: "0.42 Cd" },
    ],
    desc: "A microscopic nano-ceramic layer permanently bonded to the exterior hide. It repels water instantly, prevents UV fading, and drastically reduces wind friction drag at apex speeds.",
